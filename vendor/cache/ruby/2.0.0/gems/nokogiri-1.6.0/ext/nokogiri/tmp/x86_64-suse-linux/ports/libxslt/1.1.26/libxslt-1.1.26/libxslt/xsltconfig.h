...
#define WITH_MODULES
#endif
#define LIBXSLT_DEFAULT_PLUGINS_PATH() "/srv/redmine/plugins/xero/vendor/cache/ruby/2.0.0/gems/nokogiri-1.6.0/ports/x86_64-suse-linux/libxslt/1.1.26/lib/libxslt-plugins"
#endif
